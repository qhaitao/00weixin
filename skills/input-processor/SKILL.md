...
识别用户输入类型（关键词/本地文件），路由到对应处理器，输出标准化素材至 source/ 目录。
...
bun skills\input-processor\scripts\main.ts --dir workspace\YYYYMMDD主题 --input "用户输入"
